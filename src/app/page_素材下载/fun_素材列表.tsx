						...
						return (
							<ImageListItem key={item._id}>
								<img
									...
									onClick={() => {
										window.open(
											'http://127.0.0.1:8000/v1/MaterialDown/get_material_down_link?shop_name=' +
												down_store.shop_name +
												'&material_site=' +
												down_store.material_site +
												'&material_id=' +
												item._id +
												'&down_path=' +
												down_store.down_path,
										);
										useMaterialList.setState((state) => {
											state.material_list.splice(
												index,
												1,
											);
										});
